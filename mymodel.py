...
class Basisformer(nn.Module):
    def __init__(self, seq_len, pred_len, d_model, heads, basis_nums, block_nums, bottle, map_bottleneck, device, tau, v_num):
        super().__init__()
        ...
        self.mlstmnet = mLSTM(v_num, heads, heads, d_model, 6)
        self.device = device
    ...
    def forward(self, x, mark, y=None, train=True, y_mark=None):
        ...
        score,_ = self.mlstmnet(feature,raw_m1)
